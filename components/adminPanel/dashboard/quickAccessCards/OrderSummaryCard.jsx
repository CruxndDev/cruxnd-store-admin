...
const OrderSummaryCard = () => {
  return (
    <div className="w-[48%] h-[35em] flex flex-col rounded-2xl custom-shadow px-3 xl:px-6 py-6">
      <div className="w-full flex justify-between items-center mb-10">
        <h2 className="text-lg xl:text-xl font-semibold">Order Summary</h2>
        <div className="custom-shadow rounded-lg p-2 flex justify-between w-[65%] xl:w-[63%] text-sm xl:text-md">
